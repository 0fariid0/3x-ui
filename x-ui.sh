...
update() {
    ...
    bash <(curl -Ls https://raw.githubusercontent.com/0fariid0/3x-ui/main/update.sh)
    if [[ $? == 0 ]]; then
...
update_dev() {
    ...
    XUI_UPDATE_TAG="dev-latest" bash <(curl -Ls https://raw.githubusercontent.com/0fariid0/3x-ui/main/update.sh)
    if [[ $? == 0 ]]; then
...
update_menu() {
    ...
    if replace_xui_script "https://raw.githubusercontent.com/0fariid0/3x-ui/main/x-ui.sh" "false"; then
...
legacy_version() {
    ...
    install_command="bash <(curl -Ls "https://raw.githubusercontent.com/0fariid0/3x-ui/v$tag_version/install.sh") v$tag_version"
...
uninstall() {
    ...
    echo -e "${green}bash <(curl -Ls https://raw.githubusercontent.com/0fariid0/3x-ui/main/install.sh)${plain}"
    echo ""
...
update_shell() {
    if replace_xui_script "https://github.com/0fariid0/3x-ui/raw/main/x-ui.sh" "true"; then

...
const (
	panelUpdaterURL      = "https://raw.githubusercontent.com/0fariid0/3x-ui/main/update.sh"
...
func fetchPanelRelease(tag string) (*service.Release, error) {
	url := "https://api.github.com/repos/0fariid0/3x-ui/releases/latest"
	if tag != "" {
		url = "https://api.github.com/repos/0fariid0/3x-ui/releases/tags/" + tag
	}

...
<p align="center">
  ...
  <a href="https://github.com/0fariid0/3x-ui/actions"><img src="https://img.shields.io/github/actions/workflow/status/0fariid0/3x-ui/release.yml.svg" alt="Build"></a>
  <a href="#"><img src="https://img.shields.io/github/go-mod/go-version/0fariid0/3x-ui.svg" alt="GO Version"></a>
  <a href="https://github.com/0fariid0/3x-ui/releases/latest"><img src="https://img.shields.io/github/downloads/0fariid0/3x-ui/total.svg" alt="Downloads"></a>
...
```bash
bash <(curl -Ls https://raw.githubusercontent.com/0fariid0/3x-ui/main/install.sh) dev-latest
```
...
برای مستندات کامل، لطفاً به [ویکی پروژه](https://github.com/0fariid0/3x-ui/wiki) مراجعه کنید.
